...
class CreateSolidQueue < ActiveRecord::Migration[8.1]
  def change
    create_table 'solid_queue_blocked_execution', force: :cascade do |t|
      ...
      t.index %w[concurrency_key priority job_id], name: 'index_solid_queue_blocked_execution_for_release'
      t.index %w[expires_at concurrency_key], name: 'index_solid_queue_blocked_execution_for_maintenance'
    ...
    create_table 'solid_queue_claimed_execution', force: :cascade do |t|
      ...
      t.index %w[process_id job_id], name: 'index_solid_queue_claimed_execution_on_process_id_and_job_id'
    end
    ...
    create_table 'solid_queue_process', force: :cascade do |t|
      ...
      t.index %w[name supervisor_id], name: 'index_solid_queue_process_on_name_and_supervisor_id', unique: true
    ...
    create_table 'solid_queue_recurring_execution', force: :cascade do |t|
      ...
      t.index %w[task_key run_at], name: 'index_solid_queue_recurring_execution_on_task_key_and_run_at',
        unique: true
    end
