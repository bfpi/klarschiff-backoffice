...
class Issue < ApplicationRecord
  ...
  enum :description_status, { internal: 0, external: 1, deleted: 2 }, prefix: true
  ...
  enum :status, { pending: 0, received: 1, reviewed: 2, in_process: 3, not_solvable: 4, duplicate: 5, closed: 6,
                 deleted: 7 }, prefix: true
  enum :trust_level, { external: 0, internal: 1, field_service_team: 2 }, prefix: true
  ...
  with_options dependent: :destroy do
    has_many :issue_responsibilities
