...
class IssueExportsController < ApplicationController
  ...
  def create
    ...
    kit = PDFKit.new(render_to_string(template: 'issue_exports/create', formats: :html, layout: false).to_s,
      page_size: 'A4', margin_top: '0.5in', margin_right: '0.5in', margin_bottom: '0.5in', margin_left: '0.5in')
